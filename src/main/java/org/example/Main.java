...
public class Main {
    ...
    public static double circleArea(int radius) {
        return (Math.round(100*(Math.PI*radius*radius)))/100.00;
    }
    ...
    public static double circleCircum(int radius) {
        return ((Math.round(2*Math.PI*radius*100))/100.00);
    }
    ...
    public static String circleInfo(int radius) {
        return "Radius:\f"+radius+"\nCircumference:\f"+circleCircum(radius)+"\nArea:\f"+circleArea(radius);
    }
    ...
    public static String minutesToHoursMinutes(int minutes) {
        ...
        return hours+"hours\fand"+remainingMinutes+"minutes";
    }
    ...
    public static String twentyFourToTwelve(String time) {
        ...
        return newHours + time.substring(2, 5) + "\fpm";
    }
    ...
    public static double fahrenheitToCelsius(int fahrenheit) {
        return Math.round((fahrenheit - 32) * 5 / 9.0 * 100.0) / 100.0;
